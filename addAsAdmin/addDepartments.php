...
?>
		<form action="" method="post">
        	...
        	<h1> Department Information </h1> <br>
        		...
        		<p> Department Name </p>
			<label for="addDepartment" class="sr-only">Department Name</label>
                	<input type="text" name="departmentName" id="departmentName" class="form-control" placeholder="Enter new department" required>
        	

			<div class="d-flex flex-column mt-3">
                		<input name="submit" class="btn btn-primary btn-outline-primary my-2 my-sm-0" type="submit">
