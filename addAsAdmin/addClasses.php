...
if (isset($_POST['submit'])) {
    ...
    if (empty($data_missing)) {
        ...
        echo "Class has been successfully added!";
...
?>
      <h1 class="mb-3">Class Information</h1>

      <div style="max-width: 400px">
		  <form action="" method = "POST">
	  Course Name</br>  <input type="text" name="courseName" value=""><br>
	  Course Code</br> <input type="text" name="courseCode" value=""><br>
